...
%  background=shade-tb,
  ...
  {% The makebox allows the title to flow into the logo, this is a hack because of the L shaped logo.
    \makebox[8em][r]{%
      \begin{minipage}{16em}
        \hfill
		\includegraphics[height=5em]{labri}
        \includegraphics[height=5em]{enseirb-matmeca}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \vspace{0.3em}
   ...
   Nous documentons comment nous avons utilisé Docker comme \textbf{unité de déploiement} pour les mises en production et comme \textbf{unité de développement} pour les tests et l'Intégration Continue.
   ...
   \headerbox{Cobaye: Le Project SnapMail}{name=project,column=1,span=2,row=0}{
