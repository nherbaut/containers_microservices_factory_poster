...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{center}
   ...
   Les MS émergent des tendances actuelles de l'ingénieurie logicielle (\textit{Design Driven Development, Livraison Continue, Virtualisation, Agilité, mouvement DevOps, Antifragile}) et .
   ...
   \begin{multicols}{2}
	...
	Point de départ: deux applications monolithiques (réseau social et transcoding multimédia) ont déjà été développées et continuent à être améliorées. 
	Un nouveau projet est lancé pour ajouter des fonctionnalités au produit. Le produit aura une vie assez longue doit permettre à tout moment de remplacer un de ses composant par une version améliorée en limitant le coût d'intégration de la nouvelle brique.
